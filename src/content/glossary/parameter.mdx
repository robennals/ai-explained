...
term: parameter
aliases: [parameters]
short: One of the adjustable numbers inside a model.
firstAppearance: computation
---

A **parameter** is one of the adjustable numbers inside a [model](/glossary#model). Each parameter is one number you can change; together they decide what the model does.
