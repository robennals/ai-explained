...
A **neuron** is a [function](/glossary#function) that multiplies its inputs by [weights](/glossary#weight) and applies an [activation function](/glossary#activation-function).
