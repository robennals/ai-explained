...
Humans are tool users. We use tools to help us think (e.g. a calculator), or to look up information (e.g. a search engine), or to do things (e.g. sending an email). The program that an AI model runs inside, called the *harness*, lets it use tools in a similar way.
