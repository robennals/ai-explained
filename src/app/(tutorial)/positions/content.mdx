...
This turns out to be fine. As we'll see in the next chapter, real language models have another mechanism for direction **causal masking** that allows a token to only attend to tokens that came *before* it. RoPE handles "how far apart," and causal masking handles "which direction."
