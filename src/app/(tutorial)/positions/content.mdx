The meaning of a sentence often depends on the *order* of its words, not just on which words are there. The attention system built in the last chapter has no idea where any word sits. It sees a bag of words. This chapter is about the surprisingly geometric ways that gets fixed.
