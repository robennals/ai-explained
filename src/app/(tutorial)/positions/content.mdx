The meaning of a sentence often depends on the *order* of its words, not just on which words are there. [Attention](/attention), the mechanism at the heart of every modern AI model, is blind to that. It sees a bag of words, with no sense of where any of them sit. This chapter is about the surprisingly geometric ways that gets fixed.
