...
<Lead>
The meaning of a sentence often depends on the *order* of the words, not just which words are there. But the attention system we built in <Ch slug="attention" /> has no idea where any word is. Let's fix that.
</Lead>
