...
Start with rotation speed at 0°. Both nouns get identical attention, just like in the attention chapter. Now drag it up. The closer noun ("cat") starts winning because its key is rotated to a more similar angle to "it"'s query. This achieves the same distance preference as ALiBi, but through geometry rather than an explicit penalty.
</RotationToyTokensWidget>
