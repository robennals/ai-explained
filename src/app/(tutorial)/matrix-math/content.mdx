Every layer of a [neural network](/neurons) does the same two things to the numbers passing through it: multiply and add. That operation has a name, matrix multiplication, and it also has a geometric meaning. Each layer is a transformation of space itself, and once you can see the shape of that transformation, a lot of what networks do stops being mysterious.
