...
In 1936, two mathematicians, Alan Turing and Alonzo Church, independently arrived at the same answer. You can build a *universal* model: one capable of computing any function that can be computed at all. Not just math. Anything. This idea is called the *Church-Turing thesis*. It can't be formally proven, but no one has ever found a counterexample.
