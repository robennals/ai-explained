...
A few years ago, the things AI does routinely now would have read as science fiction. Image recognition. Translation between hundreds of languages. Generating a photorealistic image from a sentence like "a cat wearing a tiny hat on the moon." Holding a conversation that feels close to talking to a person.

The strange thing is, all of these work the same way underneath.

This tutorial explains how. Not at a "it's like a brain" level: the actual mechanism, in enough detail that you could build a small one yourself. By the end you'll understand how modern AI systems work, and why they work.
