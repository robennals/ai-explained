...
There's a target curve (the blue one) we want the model to match. Your job is to adjust the four knobs so the red curve sits on top of the blue one. The error number shows how closely the curves match.
