...
The model learned attention heads that helped it solve this task, rather than ones that make sense to humans, so its not obvious to us humans what most of these heads are doing. That's one of the weird things about AI models.
