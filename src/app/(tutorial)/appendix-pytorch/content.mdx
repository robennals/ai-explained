...
The most fundamental layer. It computes `y = x @ W.T + b` — a weighted sum of the inputs plus a bias, applied to a whole layer of neurons at once (see [Chapter 3](/neurons)):
