...
Think about it: the direction from "man" to "woman" captures something about gender. If you take the embedding for "king," subtract "man," and add "woman," you should land somewhere near "queen" — because you've removed the male component and added the female component. And it works!

This isn't limited to gender. The direction from "france" to "paris" captures something about capitals — apply it to "germany" and you get "berlin." The direction from "walk" to "walking" captures the present-participle tense — apply it to "swim" and you get "swimming." The embedding has learned many different relationships as consistent directions.

<EmbeddingArithmeticWidget>
Start with the classic: king &minus; man + woman = queen. Then explore the other categories — capitals, verb tenses, workplace roles. Try paris &minus; france + japan to see Tokyo emerge. Try walking &minus; walk + swim for tense transfer. Then try your own: pick any word for A, something it shares a relationship with for B, and the other end of that relationship for C. What analogies can you find? What happens when you try one that doesn&apos;t make sense?
</EmbeddingArithmeticWidget>

Not every analogy works. Try subtracting "cat" from "dog" and adding "piano" — you'll get other instruments, not something meaningful about dogs. The embedding only learned relationships that were useful for its training task. Gender, geography, and verb tense show up as consistent directions because they matter for predicting word usage. But "dog-ness minus cat-ness" isn't a relationship the embedding had any reason to learn.
