...
**This isn't a party trick.** It's how modern AI builds up complex meaning. In the chapter on [transformers](/transformers), we'll see that each layer of a transformer model adds vectors to deepen the model's understanding of what each word in a text is about.
