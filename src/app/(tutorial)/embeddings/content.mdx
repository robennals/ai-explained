The last chapter described animals using properties picked by hand: size, speed, scariness. That works when everything being described is the same kind of thing. Words are not. This chapter is about how AI invents its own dimensions instead, and what the resulting space of meanings looks like from the inside.
