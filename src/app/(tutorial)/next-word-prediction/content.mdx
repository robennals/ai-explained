How do you teach an AI the sum of all human knowledge? It turns out that one of the most effective ways is to train them to be really good at predicting the next word of an arbitrary piece of human written text. This chapter explains why.
