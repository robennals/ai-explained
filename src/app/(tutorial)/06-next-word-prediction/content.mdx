...
<TryIt>
**Explore tab**: Type text and see live predictions. Click any prediction to extend the sentence — try building a story! Notice how "once upon a" confidently predicts "time." Try different story beginnings like "the little" or "she was very."

**Compare tab**: See how similar words produce similar predictions. "Cat" and "dog" both predict "was" as the top word — the model learned that animals behave similarly in stories, even though it never saw a rule saying so.
</TryIt>
