Training an AI means finding good values for its parameters, and there are far more possible combinations than could ever be tried. Being clever about it does not get you far. This chapter is about the method that does work, the same one that drives evolution and A/B testing: make a tiny change, check whether it helped, keep it if it did, and repeat very fast.
