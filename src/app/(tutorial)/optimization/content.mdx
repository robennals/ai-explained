Chapter 1 ended with a puzzle. Somewhere in a space of billions of possible parameter settings is the combination that makes a model work, and there are far too many combinations to search. This chapter is about how that search is actually done. The answer has almost nothing to do with being clever.
