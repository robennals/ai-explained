...
{/* ================================================================ */}
{/* Sections below were moved from main content.mdx during the      */}
{/* "gentler progression" restructure (Feb 2026).                    */}
{/* ================================================================ */}

## Neurons as Geometry (moved)
...
## Sharp vs. Blurry — 2D View (moved)

{/* The 2D heatmap portion of the old SharpnessExplorer. The code for this */}
{/* still exists in SharpnessExplorer.tsx's git history but was removed from */}
{/* the component to simplify the main chapter. */}
