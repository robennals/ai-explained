The last chapter gave us a way to improve almost anything, as long as we can make small changes and measure whether they helped. That leaves the question of what to build out of, and what to improve. Modern AI's answer is the neural network, made from a single repeated part that is much simpler than you might expect.
