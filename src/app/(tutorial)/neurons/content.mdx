The building block of modern AI is a rough imitation of a brain cell. A neuron adds up its inputs, and if the total is high enough it fires. That is a much simpler starting point than most people expect. This chapter builds one from scratch, wires several of them together, and shows how a whole network of them can be trained by the [incremental improvement](/optimization) that all AI training relies on.
