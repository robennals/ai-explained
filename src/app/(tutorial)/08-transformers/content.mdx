...
<TryItInPyTorch notebook="08-transformers">
Build a complete transformer from scratch, train it on simple symbol patterns, visualize attention weights, train one on real text to generate children's stories, and experiment with temperature sampling and model scale.
</TryItInPyTorch>
