...
export const chapters: Chapter[] = [
  ...
  },
  {
    ...
    subtitle: "It's still the transformer",
    prerequisites: [9],
    description:
      "The models behind ChatGPT, Claude, and Gemini are mostly the transformer you just built, scaled up with a handful of simple tweaks. A tour of the five ways models get better, and a map of the chapters that explain each one.",
  },
  {
    id: 11,
    slug: "matrix-math",
