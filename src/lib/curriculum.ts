...
export const chapters: Chapter[] = [
  ...
  {
    id: 3,
    slug: "03-neural-networks",
    title: "Neural Networks",
    subtitle: "Neurons, layers, and activation functions",
    prerequisites: [2],
    description:
      "From single neurons to deep networks. Why activation functions matter, the exponential advantage of depth, and what layers actually learn.",
  },
  {
    id: 4,
    slug: "04-matrix-math",
