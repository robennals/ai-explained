...
export const LAYER_SUMMARIES: Record<LayerId, string> = {
  ...
  L3: "The object 'tail' reaches back to its verb. After this layer, 'tail' knows it's the thing being chased.",
  L4: "(unused in this example)",
  L5: "(unused in this example)",
  Predict: "The model reads the last word's row and matches it against every word it knows. The closest match is the next-word guess.",
};
